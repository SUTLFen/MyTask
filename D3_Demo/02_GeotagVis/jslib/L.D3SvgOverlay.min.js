...
(function (factory) {
    ...
    //extend(dest, src...) : 如果没有dest, 只有src, 是将src加入到调用extend的对象中
    L.D3SvgOverlay = (L.version < "1.0" ? L.Class : L.Layer).extend({
        ...
        onAdd: function (map) {
            ...
            this._wgsInitialShift = this.map.latLngToLayerPoint(this._wgsOrigin);//将经纬度【0，0】映射为叠加层坐标
    ...
    L.d3SvgOverlay = function (drawCallback, options) {
        return new L.D3SvgOverlay(drawCallback, options)  //drawCallback为回掉函数
    }
});